...
var Select = React.createClass({
	...
	getFormValue: function getFormValue(values) {
		return values.map(function (op) {
			return op.value;
	...
	autoloadAsyncOptions: function autoloadAsyncOptions() {
		...
		var values = this.getValues();
		this.loadAsyncOptions(values[0] && values[0].value || '', { isLoading: false }, function () {
	...
	render: function render() {
		...
		return React.createElement(
			...
			React.createElement('input', _extends({ type: 'hidden', ref: 'value', name: this.props.name, value: this.getFormValue(values), disabled: this.props.disabled }, this.props.hiddenInputProps)),
			React.createElement(
				'div',
